Meteor.methods({
    ...
    footballAdd: function(marketType, target, valuations, footballType) {
        ...
        var footballInactive = Footballs.findOne({
            $and: [
                {
                ...
                {
                    footballActivated: false
                }
            ]
        });
        //If inactive Football exists, make that Football active
        if (footballInactive) {
            var existingFootballId = footballInactive._id;
